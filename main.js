...
function check_sketch(){
    ...
    if(timer_counter>500){
        document.getElementById("MePro").innerHTML = "Your Sketch: ";
        document.getElementById("MeNoob").innerHTML = "Confidence: ";
        timer_counter = 0;
...
function gotResults(error,results){
    ...
    document.getElementById("MePro").innerHTML = "Your Sketch: "+results[0].label;
    document.getElementById("MeNoob").innerHTML = "Confidence: "+Math.round(results[0].confidence * 100)+"%";
}